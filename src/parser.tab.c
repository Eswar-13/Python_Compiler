...
static const yytype_int16 yyrline[] =
{
     ...
     284,   287,   288,   289,   290,   293,   294,   297,   298,   301,
     302,   305,   306,   307,   308,   309,   310,   311,   312,   313,
     314,   315,   316,   317,   322,   323,   324,   327,   328,   333,
...
#line 97 "parser.y"
                               {fprintf(yyout,"{rank = same; %d -- %d -- %d  [ style=invis ];rankdir = LR;}",(yyvsp[-2].attributes).low,node,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d; %d[label=\" Delimiter(;)\"];\n",(yyvsp[-2].attributes).top,node,node); fprintf(yyout,"%d--%d;\n",(yyvsp[-2].attributes).top,(yyvsp[0].attributes).top); node++; (yyval.attributes).top=(yyvsp[-2].attributes).top; (yyval.attributes).low=(yyvsp[0].attributes).top;}
#line 1502 "parser.tab.c"
    break;

  case 11: /* more_expr: small_stmt  */
#line 98 "parser.y"
            {fprintf(yyout,"%d--%d; %d[label=\" Stmt List\"];\n",node,(yyvsp[0].attributes).top,node); node++; (yyval.attributes).top=node-1; (yyval.attributes).low=(yyvsp[0].attributes).top;}
...
#line 111 "parser.y"
                                          {fprintf(yyout,"%d--%d; %d--%d; %d[label=\"Operator (%s)\"];\n",(yyvsp[-2].attributes).low,node,node,(yyvsp[0].attributes).top,node,integerToOperator((yyvsp[-1].attributes).top)); node++; fprintf(yyout,"%d--%d; %d[label=\" Expr\"];\n",node,(yyvsp[-2].attributes).top,node); node++; (yyval.attributes).top=node-1; }
#line 1544 "parser.tab.c"
    break;

  case 18: /* expr_stmt: testlist Assign_stmt  */
#line 112 "parser.y"
                        { fprintf(yyout,"%d--%d;\n",(yyvsp[-1].attributes).low,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d; %d[label=\" Expr\"];\n",node,(yyvsp[-1].attributes).top,node); node++; (yyval.attributes).top=node-1;}
#line 1550 "parser.tab.c"
    break;

  case 19: /* Assign_stmt: Assign_stmt ASSIGNMENT_OPERATOR testlist  */
#line 115 "parser.y"
                                          {fprintf(yyout,"%d--%d; %d--%d;%d[label=\"assignment\"];\n",node,(yyvsp[0].attributes).top,(yyvsp[-2].attributes).low,node,node); node++; (yyval.attributes).top=(yyvsp[-2].attributes).top; (yyval.attributes).low=(yyvsp[0].attributes).low;}
#line 1556 "parser.tab.c"
    break;

  case 20: /* Assign_stmt: ASSIGNMENT_OPERATOR testlist  */
#line 116 "parser.y"
                                 {fprintf(yyout,"%d--%d; %d[label=\"assignment\"];\n",node,(yyvsp[0].attributes).top,node); node++; (yyval.attributes).top=node-1; (yyval.attributes).low=(yyvsp[0].attributes).low;}
#line 1562 "parser.tab.c"
    break;

  case 21: /* annassign: COLON test param_list  */
#line 119 "parser.y"
                                  {fprintf(yyout,"{rank = same; %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node,(yyvsp[-1].attributes).top,(yyvsp[0].attributes).top); fprintf(yyout,"%d[label=\" COLON\"];\n",node); node++;  fprintf(yyout,"%d--%d; %d--%d;  %d--%d; %d[label=\" Annassign\"];\n",node,(yyvsp[-1].attributes).top,node,(yyvsp[0].attributes).top,node,node-1,node); node++; (yyval.attributes).top=node-1;  }
#line 1568 "parser.tab.c"
    break;

  case 22: /* annassign: COLON test  */
#line 120 "parser.y"
                         {fprintf(yyout,"{rank = same; %d -- %d  [ style=invis ];rankdir = LR;}",node,(yyvsp[0].attributes).top); fprintf(yyout,"%d[label=\" COLON\"];\n",node); node++; (yyval.attributes).top=node-1; fprintf(yyout,"%d--%d; %d--%d; %d[label=\" Annassign\"];\n",node,(yyvsp[0].attributes).top,node,node-1,node); node++; (yyval.attributes).top=node-1;}
#line 1574 "parser.tab.c"
    break;

  case 23: /* param_list: ASSIGNMENT_OPERATOR test  */
#line 124 "parser.y"
                          {fprintf(yyout,"%d[label=\"assignment\"];\n",node); node++; fprintf(yyout,"%d--%d; %d--%d; %d[label=\" param_list \"];\n",node,node-1,node-1,(yyvsp[0].attributes).top,node); node++; (yyval.attributes).top=node-1;}
...
#line 147 "parser.y"
                           {fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1640 "parser.tab.c"
    break;

  case 34: /* if_stmt: IF test COLON suite else_statement  */
#line 148 "parser.y"
                                       {fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-3].attributes).top,node+2,(yyvsp[-1].attributes).top,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-3].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
...
#line 150 "parser.y"
                                                      {fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d -- %d[ style=invis ];rankdir = LR;}",node+1,(yyvsp[-4].attributes).top,node+2,(yyvsp[-2].attributes).top,(yyvsp[-1].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-4].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;\n",(yyvsp[-1].attributes).low,(yyvsp[0].attributes).top); node=node+3; (yyval.attributes).top=node-3;}
#line 1658 "parser.tab.c"
    break;

  case 37: /* elif_statements: elif_statements ELIF test COLON suite  */
#line 153 "parser.y"
                                       { fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;\n",(yyvsp[-4].attributes).top,node); fprintf(yyout,"%d--%d;%d[label=\"Keyword(elif)\"];%d[label=\"elif_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=(yyvsp[-4].attributes).top; (yyval.attributes).low=node-3;}
#line 1664 "parser.tab.c"
    break;

  case 38: /* elif_statements: ELIF test COLON suite  */
#line 154 "parser.y"
                                      { fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(elif)\"];%d[label=\"elif_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2); fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top); node=node+3; (yyval.attributes).top=node-3; (yyval.attributes).low=node-3;}
#line 1670 "parser.tab.c"
    break;

  case 39: /* else_statement: ELSE COLON suite  */
#line 157 "parser.y"
                        { fprintf(yyout,"{rank = same; %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,node+2,(yyvsp[0].attributes).top);  fprintf(yyout,"%d--%d;%d[label=\"Keyword(else)\"];%d[label=\"else_statement\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1676 "parser.tab.c"
    break;

  case 40: /* while_stmt: WHILE test COLON suite  */
#line 161 "parser.y"
                                    { fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(while)\"];%d[label=\"while_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1682 "parser.tab.c"
    break;

  case 41: /* while_stmt: WHILE test COLON suite else_statement  */
#line 162 "parser.y"
                                                    { fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-3].attributes).top,node+2,(yyvsp[-1].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(while)\"];%d[label=\"while_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-3].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1688 "parser.tab.c"
    break;

  case 42: /* for_stmt: FOR exprlist IN testlist COLON suite  */
#line 166 "parser.y"
                                                   { fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-4].attributes).top,node+2,(yyvsp[-2].attributes).top,node+3,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(for)\"];%d[label=\"for_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-4].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(in)\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+4;(yyval.attributes).top=node-4;}
#line 1694 "parser.tab.c"
    break;

  case 43: /* for_stmt: FOR exprlist IN testlist COLON suite else_statement  */
#line 167 "parser.y"
                                                                     { fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d -- %d -- %d -- %d[ style=invis ];rankdir = LR;}",node+1,(yyvsp[-5].attributes).top,node+2,(yyvsp[-3].attributes).top,node+3,(yyvsp[-1].attributes).top,(yyvsp[0].attributes).top);  fprintf(yyout,"%d--%d;%d[label=\"Keyword(for)\"];%d[label=\"for_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-5].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(in)\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-3].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+4;(yyval.attributes).top=node-4;}
#line 1700 "parser.tab.c"
    break;

  case 44: /* funcdef: DEF name parameters COLON suite  */
#line 171 "parser.y"
                                     {fprintf(yyout,"{rank = same;%d -- %d -- %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-3].attributes).top,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(def)\"];%d[label=\"funcdef\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-3].attributes).top); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1706 "parser.tab.c"
    break;

  case 45: /* funcdef: DEF name parameters RETURN_ARROW test COLON suite  */
#line 172 "parser.y"
                                                      {fprintf(yyout,"{rank = same;%d -- %d -- %d -- %d -- %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-5].attributes).top,(yyvsp[-4].attributes).top,node+2,(yyvsp[-2].attributes).top,node+3,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(def)\"];%d[label=\"funcdef\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-5].attributes).top); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-4].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(->)\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+4;(yyval.attributes).top=node-4;}
#line 1712 "parser.tab.c"
    break;

  case 46: /* parameters: LEFT_BRACKET RIGHT_BRACKET  */
#line 175 "parser.y"
                                             {fprintf(yyout,"{rank = same;  %d -- %d  [ style=invis ];rankdir = LR;}",node+1,node+2);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(()\"];%d[label=\"parameters\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER())\"];\n",node,node+2,node+2);node=node+3;(yyval.attributes).top=node-3;}
#line 1718 "parser.tab.c"
    break;

  case 47: /* parameters: LEFT_BRACKET typedargslist RIGHT_BRACKET  */
#line 176 "parser.y"
                                             {fprintf(yyout,"{rank = same;  %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-1].attributes).top,node+2);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(()\"];%d[label=\"parameters\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER())\"];\n",node,node+2,node+2);node=node+3;(yyval.attributes).top=node-3;}
...
#line 181 "parser.y"
              {fprintf(yyout,"%d--%d; %d[label=\"typedef_list\"];\n",node,(yyvsp[0].attributes).top,node); node++; (yyval.attributes).top=node-1; (yyval.attributes).low=(yyvsp[0].attributes).top;}
#line 1736 "parser.tab.c"
    break;

  case 50: /* full_tfpdef: name COLON test  */
#line 185 "parser.y"
                           {fprintf(yyout,"{rank = same;  %d -- %d -- %d  [ style=invis ];rankdir = LR;}",(yyvsp[-2].attributes).top,node+1,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];%d[label=\"typedef\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node+=2 ;(yyval.attributes).top=node-2;}
#line 1742 "parser.tab.c"
    break;

  case 51: /* full_tfpdef: NAME  */
#line 186 "parser.y"
                     {fprintf(yyout,"%d[label=\"NAME( %s )\"];\n",node,lexeme);node++;(yyval.attributes).top=node-1;}
...
#line 193 "parser.y"
                                        {fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-3].attributes).top,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(class)\"];%d[label=\"class_def\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-3].attributes).top); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1760 "parser.tab.c"
    break;

  case 54: /* classdef: CLASS name COLON suite  */
#line 194 "parser.y"
                             {fprintf(yyout,"{rank = same; %d -- %d -- %d -- %d [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-2].attributes).top,node+2,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(class)\"];%d[label=\"class_def\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;\n",node,(yyvsp[-2].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,(yyvsp[0].attributes).top);node=node+3;(yyval.attributes).top=node-3;}
#line 1766 "parser.tab.c"
    break;

  case 55: /* opt_class_arg: LEFT_BRACKET RIGHT_BRACKET  */
#line 198 "parser.y"
                              {fprintf(yyout,"{rank = same;  %d -- %d  [ style=invis ];rankdir = LR;}",node+1,node+2);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER({)\"];%d[label=\"opt_class_arg\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(})\"];\n",node,node+2,node+2);node=node+3;(yyval.attributes).top=node-3;}
#line 1772 "parser.tab.c"
    break;

  case 56: /* opt_class_arg: LEFT_BRACKET opt_arglist RIGHT_BRACKET  */
#line 199 "parser.y"
                                            {fprintf(yyout,"{rank = same;  %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,(yyvsp[-1].attributes).top,node+2);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER({)\"];%d[label=\"opt_class_arg\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(})\"];\n",node,node+2,node+2);node=node+3;(yyval.attributes).top=node-3;}
...
#line 209 "parser.y"
                                     {fprintf(yyout,"%d--%d; %d[label=\" arglist\"];\n",node,(yyvsp[0].attributes).top,node); node++; (yyval.attributes).top=node-1; (yyval.attributes).low=(yyvsp[0].attributes).top;}
...
#line 301 "parser.y"
                    {fprintf(yyout,"{rank = same; %d -- %d  [ style=invis ];rankdir = LR;}",(yyvsp[-1].attributes).low,(yyvsp[0].attributes).top); fprintf(yyout,"%d--%d;\n",(yyvsp[-1].attributes).top,(yyvsp[0].attributes).top); (yyval.attributes).top=(yyvsp[-1].attributes).top; (yyval.attributes).low=(yyvsp[0].attributes).top;}
#line 2096 "parser.tab.c"
    break;

  case 110: /* opt_trailer: trailer  */
#line 302 "parser.y"
            {fprintf(yyout,"%d--%d; %d[label=\"trailer_list\"];\n",node,(yyvsp[0].attributes).top,node); node++; (yyval.attributes).top=node-1; (yyval.attributes).low=(yyvsp[0].attributes).top;}
#line 2102 "parser.tab.c"
    break;

  case 111: /* atom: LEFT_BRACKET testlist_comp RIGHT_BRACKET  */
#line 305 "parser.y"
                                                   {fprintf(yyout,"{rank = same; rank%d[style=invisible]; rank%d -- %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,node+1,node,(yyvsp[-1].attributes).top,node+2);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"atom\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; (yyval.attributes).top=node-2;}
#line 2108 "parser.tab.c"
    break;

  case 112: /* atom: LEFT_BRACKET RIGHT_BRACKET  */
#line 306 "parser.y"
                                                   {fprintf(yyout,"{rank = same; rank%d[style=invisible]; rank%d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,node+1,node,node+2);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"atom\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; (yyval.attributes).top=node-2;}
...
#line 323 "parser.y"
                       {(yyval.attributes).top = (yyvsp[-1].attributes).top;fprintf(yyout,"%d--%d; %d[label=\" Delimiter(,)\"];\n",(yyvsp[-1].attributes).top,node,node);node++;}
...
#line 333 "parser.y"
                                             {fprintf(yyout,"{rank = same; rank%d[style=invisible]; rank%d -- %d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,node+1,node,(yyvsp[-1].attributes).top,node+2);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,(yyvsp[-1].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; (yyval.attributes).top=node-2;}
#line 2216 "parser.tab.c"
    break;

  case 130: /* trailer: LEFT_BRACKET RIGHT_BRACKET  */
#line 334 "parser.y"
                                             {fprintf(yyout,"{rank = same; rank%d[style=invisible]; rank%d -- %d -- %d  [ style=invis ];rankdir = LR;}",node+1,node+1,node,node+2);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; (yyval.attributes).top=node-2;}
...
#line 336 "parser.y"
                                             {fprintf(yyout,"{rank = same; rank%d[style=invisible]; rank%d -- %d -- %d   [ style=invis ];rankdir = LR;}",node+1,node+1,node,(yyvsp[0].attributes).top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(.)\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,(yyvsp[0].attributes).top);node+=2; (yyval.attributes).top=node-1;}
