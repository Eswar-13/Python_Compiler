...
;
more_expr:
more_expr SEMICOLON small_stmt {fprintf(yyout,"%d--%d; %d[label=\" DELIMITER(;)\"];\n",$1.top,node,node); node++; $$.top=$1.top; fprintf(yyout,"%d--%d;\n",$1.top,$3.top);}
...
| RETURN test %prec high   {fprintf(yyout,"%d[label=\" KEYWORD(return) \"];\n",node); node++;  fprintf(yyout,"%d--%d;%d--%d;%d[label=\" return_stmt \"];\n",node,node-1,node,$2.top,node); node++; $$.top=node-1;}
;
...
;
if_stmt: 
IF test COLON suite        { fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);node=node+3;$$.top=node-3;}
|IF test COLON suite else_statement    { fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);fprintf(yyout,"%d--%d;\n",node,$5.top);node=node+3;$$.top=node-3;}
|IF test COLON suite elif_statements   { fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);fprintf(yyout,"%d--%d;\n",node,$5.top);node=node+3;$$.top=node-3;}
|IF test COLON suite elif_statements else_statement   { fprintf(yyout,"%d--%d;%d[label=\"Keyword(if)\"];%d[label=\"if_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);fprintf(yyout,"%d--%d;\n",node,$5.top);fprintf(yyout,"%d--%d;\n",node,$6.top);node=node+3;$$.top=node-3;}
;
elif_statements: 
elif_statements ELIF test COLON suite  {fprintf(yyout,"%d--%d;\n",node,$1.top); fprintf(yyout,"%d--%d;%d[label=\"Keyword(elif)\"];%d[label=\"elif_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$3.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$5.top);node=node+3;$$.top=node-3;}
|ELIF test COLON suite                {fprintf(yyout,"%d--%d;%d[label=\"Keyword(elif)\"];%d[label=\"elif_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);node=node+3;$$.top=node-3;}
;
else_statement: 
ELSE COLON suite        {fprintf(yyout,"%d--%d;%d[label=\"Keyword(else)\"];%d[label=\"else_statement\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$3.top);node=node+3;$$.top=node-3;}
;

while_stmt: 
WHILE test COLON suite %prec low    {fprintf(yyout,"%d--%d;%d[label=\"Keyword(while)\"];%d[label=\"while_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);node=node+3;$$.top=node-3;}
|WHILE test COLON suite else_statement %prec high   { fprintf(yyout,"%d--%d;%d[label=\"Keyword(while)\"];%d[label=\"while_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);fprintf(yyout,"%d--%d;\n",node,$5.top);node=node+3;$$.top=node-3;}
;

for_stmt: 
FOR exprlist IN testlist COLON suite %prec low     {fprintf(yyout,"%d--%d;%d[label=\"Keyword(for)\"];%d[label=\"for_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(in)\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,$6.top);node=node+4;$$.top=node-4;}
| FOR exprlist IN testlist COLON suite else_statement %prec high     {fprintf(yyout,"%d--%d;%d[label=\"Keyword(for)\"];%d[label=\"for_statement\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"Keyword(in)\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;\n",node,$4.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,$6.top);fprintf(yyout,"%d--%d;\n",node,$7.top);node=node+4;$$.top=node-4;}
;

funcdef: 
DEF NAME parameters COLON suite      {fprintf(yyout,"%d--%d;%d[label=\"Keyword(def)\"];%d[label=\"funcdef\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"NAME\"];\n",node,node+2,node+2); fprintf(yyout,"%d--%d;\n",node,$3.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,$5.top);node=node+4;$$.top=node-4;}
| DEF NAME parameters RETURN_ARROW test COLON suite   {fprintf(yyout,"%d--%d;%d[label=\"DEF\"];%d[label=\"funcdef\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"NAME\"];\n",node,node+2,node+2); fprintf(yyout,"%d--%d;\n",node,$3.top);fprintf(yyout,"%d--%d;%d[label=\"RETURN_ARROW\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,$5.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+4,node+4);fprintf(yyout,"%d--%d;\n",node,$7.top);node=node+5;$$.top=node-5;}
;

parameters: LEFT_BRACKET RIGHT_BRACKET       {fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(()\"];%d[label=\"parameters\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER())\"];\n",node,node+2,node+2);node=node+3;$$.top=node-3;}
| LEFT_BRACKET typedargslist RIGHT_BRACKET   {fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(()\"];%d[label=\"parameters\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER())\"];\n",node,node+2,node+2);node=node+3;$$.top=node-3;}
;

typedargslist: 
typedargslist COMMA full_tfpdef { fprintf(yyout,"%d--%d;\n",node,$1.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];%d[label=\"typedargslist\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$3.top);node=node+2;$$.top=node-2;}
| full_tfpdef {$$.top=$1.top;}
;

full_tfpdef: 
name annassign %prec high  {fprintf(yyout,"%d--%d;\n",$2.top,$1.top); $$.top=$2.top;}
|NAME %prec low     {fprintf(yyout,"%d[label=\"NAME( %s )\"];\n",node,yytext);node++;}
;
name: NAME {fprintf(yyout,"%d[label=\"NAME( %s )\"];\n",node,yytext);node++;}
;

classdef: 
CLASS NAME opt_class_arg COLON suite    {fprintf(yyout,"%d--%d;%d[label=\"Keyword(class)\"];%d[label=\"class_def\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"NAME\"];\n",node,node+2,node+2); fprintf(yyout,"%d--%d;\n",node,$3.top);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,$5.top);node=node+4;$$.top=node-4;}
|CLASS NAME COLON suite      {fprintf(yyout,"%d--%d;%d[label=\"Keyword(class)\"];%d[label=\"class_def\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"NAME\"];\n",node,node+2,node+2);fprintf(yyout,"%d--%d;%d[label=\"COLON\"];\n",node,node+3,node+3);fprintf(yyout,"%d--%d;\n",node,$4.top);node=node+4;$$.top=node-4;}
;

opt_class_arg: 
LEFT_BRACKET RIGHT_BRACKET    {fprintf(yyout,"%d--%d;%d[label=\"DELIMITER({)\"];%d[label=\"opt_class_arg\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(})\"];\n",node,node+2,node+2);node=node+3;$$.top=node-3;}
|LEFT_BRACKET opt_arglist RIGHT_BRACKET     {fprintf(yyout,"%d--%d;%d[label=\"DELIMITER({)\"];%d[label=\"opt_class_arg\"];\n",node,node+1,node+1,node); fprintf(yyout,"%d--%d;\n",node,$2.top);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(})\"];\n",node,node+2,node+2);node=node+3;$$.top=node-3;}
;
...
arglist: 
arglist COMMA argument %prec high   {fprintf(yyout,"%d--%d;\n",node,$1.top);fprintf(yyout,"%d--%d;%d[label=\"DELIMITER(,)\"];%d[label=\"arglist\"];\n",node,node+1,node+1,node);fprintf(yyout,"%d--%d;\n",node,$3.top);node=node+2;$$.top=node-2;}
| argument %prec low                 {$$.top=$1.top;}
;
...
;
opt_trailer:
opt_trailer trailer {$$.top=$2.top;}
|trailer    {$$.top=$1.top;}
;
atom:
LEFT_BRACKET testlist_comp RIGHT_BRACKET           {fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"atom\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,$2.top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
|LEFT_BRACKET  RIGHT_BRACKET                       {fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"atom\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
|LEFT_SQUARE_BRACKET  RIGHT_SQUARE_BRACKET         {fprintf(yyout,"%d--%d;%d[label=\"Delimiter([)\"];%d[label=\"atom\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(])\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
|LEFT_SQUARE_BRACKET testlist_comp RIGHT_SQUARE_BRACKET     {fprintf(yyout,"%d--%d;%d[label=\"Delimiter([)\"];%d[label=\"atom\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,$2.top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(])\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
|NAME       {fprintf(yyout,"%d[label=\"Name( %s )\"];\n",node,yytext);node++; $$.top=node-1;}
|NUMBER     {fprintf(yyout,"%d[label=\"Number( %s )\"];\n",node,yytext);node++; $$.top=node-1;}
|DATA_TYPE  {fprintf(yyout,"%d[label=\"Data Type( %s )\"];\n",node,yytext);node++; $$.top=node-1;}
|STRING {fprintf(yyout,"%d[label=\"String( %s )\"];\n",node,addBackslashBeforeQuotes(yytext));node++; $$.top=node-1;} 
...
| opt_test_stmt COMMA  {fprintf(yyout,"%d--%d;%d[label=\"testlist_comp\"];\n",node,$1.top,node); fprintf(yyout,"%d--%d;%d[label=\"Delimiter(,)\"];\n",node,node+1,node+1);node=node+2;$$.top=node-2;}
| opt_test_stmt {$$.top = $1.top;}
;

opt_test_stmt: test {$$.top = $1.top;}
|opt_test_stmt COMMA test  {fprintf(yyout,"%d--%d;%d[label=\"opt_test_stmt\"];\n",node,$1.top,node); fprintf(yyout,"%d--%d;%d[label=\"Delimiter(,)\"];\n",node,node+1,node+1);fprintf(yyout,"%d--%d;\n",node,$3.top);node=node+2;$$.top=node-2;}
;


trailer: 
LEFT_BRACKET arglist RIGHT_BRACKET           {fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,$2.top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
| LEFT_BRACKET RIGHT_BRACKET                 {fprintf(yyout,"%d--%d;%d[label=\"Delimiter(()\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;%d[label=\"Delimiter())\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
| LEFT_SQUARE_BRACKET test RIGHT_SQUARE_BRACKET    {fprintf(yyout,"%d--%d;%d[label=\"Delimiter([)\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,$2.top);fprintf(yyout,"%d--%d;%d[label=\"Delimiter(])\"];\n",node+1,node+2,node+2);node+=3; $$.top=node-2;}
| DOT name                                   {fprintf(yyout,"%d--%d;%d[label=\"Delimiter(.)\"];%d[label=\"trailer\"];\n",node+1,node,node,node+1);fprintf(yyout,"%d--%d;\n",node+1,$2.top);node+=2; $$.top=node-1;}
;

testlist: 
testlist COMMA test {fprintf(yyout,"%d--%d;%d[label=\"testlist\"];\n",node,$1.top,node); fprintf(yyout,"%d--%d;%d[label=\"Delimiter(,)\"];\n",node,node+1,node+1);fprintf(yyout,"%d--%d;\n",node,$3.top);node=node+2;$$.top=node-2;} 
| test {$$.top=$1.top;}
;

exprlist: 
exprlist COMMA expr {fprintf(yyout,"%d--%d;%d[label=\"exprlist\"];\n",node,$1.top,node); fprintf(yyout,"%d--%d;%d[label=\"Delimiter(,)\"];\n",node,node+1,node+1);fprintf(yyout,"%d--%d;\n",node,$3.top);node=node+2;$$.top=node-2;} 
| expr {$$.top=$1.top;}
;
